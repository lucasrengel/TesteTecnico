...
if __name__ == "__main__":
    ...
    #updateVendedorDB(novo_vendedor, nome="Joao", cpf="070", datansc="2004-12-12", email="jao@hotmail.com", estado="SC")

    ###Atualizando um Vendedor com o cpf cadastrado
    updateVendedorDB(novo_vendedor, nome="Lucas", cpf="123", datansc="2005-04-12", email="lucaslangel@hotmail.com", estado="SC")
